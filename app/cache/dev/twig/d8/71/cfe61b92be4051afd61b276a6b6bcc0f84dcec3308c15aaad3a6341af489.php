...
/* JorgeGespagosBundle:Usuario:show.html.twig */
class __TwigTemplate_d871cfe61b92be4051afd61b276a6b6bcc0f84dcec3308c15aaad3a6341af489 extends Twig_Template
{
    ...
    <li>
        <a href=\"";
        // line 50
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("admin_usuario_edit", array("id" => $this->getAttribute((isset($context["entity"]) ? $context["entity"] : $this->getContext($context, "entity")), "id"))), "html", null, true);
        echo "\">
            Edit
        </a>
    </li>
...
";
    ...
    {
        return "JorgeGespagosBundle:Usuario:show.html.twig";
    }
